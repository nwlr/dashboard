<div class="bg-gray-100 rounded-lg p-4 flex justify-center flex-col items-center" wire:poll.10000ms>
    <div class="text-6xl font-bold mt-4 text-red-600">{{ $data }}%</div>
