<div class="bg-gray-100 rounded-lg p-4 flex justify-center flex-col items-center" wire:poll.5000ms>
    <div class="text-6xl font-bold mt-4 text-gray-600 ">{{ $data }}</div>
